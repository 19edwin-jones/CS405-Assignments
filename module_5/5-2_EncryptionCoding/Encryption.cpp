// Encryption.cpp : This file contains the 'main' function. Program execution
...
std::string get_student_name(const std::string &string_data) {
  ...
  if (pos !=
      std::string::npos) { // we did, so copy that substring as the student name
...
int main() {
  ...
  // Line 2: <Lorem Ipsum Generator website used> https://pirateipsum.me/ (could
  // be https://www.lipsum.com/ or one of
  ...
  //  Fire in the hole bowsprit Jack Tar gally holystone sloop grog heave to
  //  grapple Sea Legs. Gally hearties case shot crimp spirits pillage galleon
  //  chase guns skysail yo-ho-ho. Jury mast coxswain measured fer yer chains
  //  man-of-war Privateer yardarm aft handsomely Jolly Roger mutiny. Hulk
  //  coffer doubloon Shiver me timbers long clothes skysail Nelsons folly reef
  //  sails Jack Tar Davy Jones' Locker. Splice the main brace ye fathom me
  //  bilge water walk the plank bowsprit gun Blimey wench. Parrel Gold Road
  //  clap of thunder Shiver me timbers hempen halter yardarm grapple wench
  //  bilged on her anchor American Main. Brigantine coxswain interloper jolly
  //  boat heave down cutlass crow's nest wherry dance the hempen jig spirits.
  //  Interloper Sea Legs plunder shrouds knave sloop run a shot across the bow
  //  Jack Ketch mutiny barkadeer. Heave to gun matey Arr draft jolly boat
  //  marooned Cat o'nine tails topsail Blimey.
  ...
  // students submit input file, encrypted file, decrypted file, source code
  // file, and key used
}
