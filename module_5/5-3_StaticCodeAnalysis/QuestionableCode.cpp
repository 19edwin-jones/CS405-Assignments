// QuestionableCode.cpp : This file contains the 'main' function. Program
...
// TODO: You are going to compare the warnings & errors between Visual Studio
// and CppCheck.
...
//  3. Create a CppCheck project to analyze a Visual Studio project with this
//  file.
//  4. In CppCheck Edit / Preferences / General Tab: Set Display error id in
//  column "Id", Enable inline suppressions, and Check for inconclusive errors
//  also
//  5. In CppCheck View, Select Check All to ensure all types of checks are
//  enabled
...
//  9. Take a screen shot of the Visual Studio Error list (all errors, warnings,
//  and messages)
...
public:
  ...
  void DontThrow() noexcept { throw "Ha! I threw anyway!"; }
};
